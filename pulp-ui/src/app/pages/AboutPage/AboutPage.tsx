    ...
    <>
      ...
      <PageWrapper>
        <Wrapper>
          ...
          <Lead className="mt-4">If you are already familiar with decentralized apps, don't hesitate:</Lead>
        ...
        <List>
          <Feature>
            ...
            <Content>
              ...
              <P>You need to be able to use a crypto identity service like Metamask.</P>
              <P>
                <LinkContainer to="/auth/login" className="mr-3">
